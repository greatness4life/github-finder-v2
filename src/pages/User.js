...
import { getUserWithRepos } from "../context/github/GithubAction";
      ...
      <>
        <div className="w-full mx-auto lg:w-10/12">
            ...
            <div className="col-span-2">
              <div className="mb-6">
                <h1 className="text-3xl card-title">
                  ...
                  {hireable && (
                    <div className="mx-1 badge-info rounded-md px-2">
                      Hireable
                    </div>
                  )}
                </h1>
                ...
                {blog && (
                  <div className="stat">
                    ...
                    <div className="text-lg stat-value">
                      <a href={userWebsite} target="_blank" rel="noreferrer">
                        {userWebsite}
                      </a>
                    </div>
                  </div>
          ...
          <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats stats-vertical lg:stats-horizontal">
            ...
            <div className="stat">
              <div className="stat-figure text-secondary">
                <FaCode className="text-4xl md:text-6xl" />
              </div>
